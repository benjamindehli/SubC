// SubC — a thin product wrapper. All behaviour lives in the shared engine
// (dm::ManifestPluginProcessor); this only supplies the embedded asset bundle. Samples
// come from a memory-mapped disk pack whose path the engine derives from the product name.
